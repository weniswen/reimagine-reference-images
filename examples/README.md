...
| --- | --- |
| ![Reference: cozy illustrated domestic scene](storybook-watercolor-reference.png) | ![Result: mother goose pulling goslings through a spring garden](storybook-watercolor-result.png) |
...
| Reference | Reimagined result |
| --- | --- |
| ![Reference: close-up of dew-covered grass](macro-nature-reference.png) | ![Result: glass frog leaping between wet red leaves](macro-nature-result.png) |
...
| Reference | Reimagined result |
| --- | --- |
| ![Reference: flock of pink birds in flight](underwater-motion-reference.png) | ![Result: sea lions swimming through a kelp forest](underwater-motion-result.png) |
